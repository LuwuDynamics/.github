<p align="center">
  <img src="./logo.png" alt="LuwuDynamics Logo" width="400">
</p>
...
<table>
  <tr>
    <td>🦾 <b>Robot Kinematics</b><br><sub>机器人运动学</sub></td>
    <td>Real-time forward and inverse kinematics solvers for serial manipulators, mobile platforms, and legged robots.<br><sub>实时正逆运动学求解，支持串联机械臂、移动平台及足式机器人。</sub></td>
  </tr>
  <tr>
    <td>🧠 <b>Motion Planning & Tracking</b><br><sub>运动规划与跟踪</sub></td>
    <td>Path planning and trajectory tracking for robots operating in complex structured and unstructured environments.<br><sub>路径规划与轨迹跟踪，适用于复杂结构化与非结构化环境下的机器人系统。</sub></td>
  </tr>
  <tr>
    <td>🖥️ <b>Simulation Model Assets</b><br><sub>仿真模型资产</sub></td>
    <td>Robot model files for major simulation platforms — including Gazebo, Isaac Sim, and MuJoCo — for rapid prototyping and validation.<br><sub>提供 Gazebo、Isaac Sim、MuJoCo 等主流仿真平台的机器人模型文件，支持快速原型验证。</sub></td>
  </tr>
  <tr>
    <td>⚙️ <b>Robot Middleware</b><br><sub>机器人中间件</sub></td>
    <td>Cross-platform middleware with C and Python SDKs for secondary development — unified access to actuators, sensors, and embedded controllers.<br><sub>跨平台通用中间件，提供 C / Python 二次开发接口，统一封装执行器、传感器与嵌入式控制器。</sub></td>
  </tr>
  <tr>
    <td>📡 <b>Edge Perception</b><br><sub>边缘感知</sub></td>
    <td>Compact perception models optimized for low-latency inference on edge hardware.<br><sub>边缘端轻量化感知小模型，实现低延迟快速感知。</sub></td>
  </tr>
</table>
...
| 🗣️ [Discussion Forum / 讨论论坛](https://github.com/orgs/LuwuDynamics/discussions) | Long-form Q&A, ideas, and knowledge sharing / 长文问答、创意交流与知识分享 |
